...
# Free tables from PDF prison! `r emo::ji('hammer_and_pick')` `r emo::ji('hole')` `r emo::ji('helicopter')` {.tabset .tabset-fade .tabset-pills}
...
knitr::include_graphics(here("images","dhs_uganda_2016_tableEx.png"))
```
...
#### **`r emo::ji("rotating_light")` Please see my package [`fetchdhs`](https://github.com/murphy-xq/fetchdhs) to do just that! `r emo::ji("rotating_light")`** {align=center}  
...
knitr::include_graphics(here("images","dhs_uganda_2016_headrEx.png"))
```
...
### We just built a function that scraped 8 tables of data from 4 different PDFs and created a tidy data frame `r emo::ji("clap")` `r emo::ji("clap")` `r emo::ji("clap")` {align=center}  

```{r, fig.align="center", out.width="60%", echo=FALSE}
knitr::include_graphics(here("images","shawshank_escape.gif"))
````